...
// double		*sprites_2(t_list *list, int x, int y, double tempo);
// double		*sprites_3(t_list *list, int x, int y, double tempo);
// double		*sprites_4(t_list *list, int x, int y, double tempo);
int		sort(double *big);
